    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          success:
            "group-[.toaster]:!bg-gradient-to-r group-[.toaster]:!from-success/15 group-[.toaster]:!to-success/5 group-[.toaster]:!border-success/30 group-[.toaster]:!text-success-foreground [&>svg]:!text-success",
          error:
